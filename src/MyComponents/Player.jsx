    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            <div className='flex gap-4'>
                ...
                {isPlaying ? <img onClick={pause} className='w-4 cursor-pointer' src={assets.pause_icon} alt="" /> : <img onClick={play} className='w-4 cursor-pointer' src={assets.play_icon} alt="" />}
            ...
            <div className='flex items-center gap-5'>
                ...
                <div onClick={seekSong} ref={seekBG} className='w-60 max-w-[500px] bg-gray-300 rounded-full cursor-pointer'>
